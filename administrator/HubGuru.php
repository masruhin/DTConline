...
$pesanGuru->CekValidationEmail($host, $_GET['to']);
$ProfilTujuan = $pesanGuru->GetIdentitasPengirim($host, $_GET['to']);
?>
          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item has-treeview menu-open">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="PesanGuru.php" class="nav-link active">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Pesan Accessor</p>
                    </a>
                  </li>
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item"><a href="PesanGuru.php">Pesan Accessor</a></li>
              ...
              <div class="col-12">
                ...
                <div class="card card-primary card-outline">
                  ...
                  <div class="card-body">
                    ...
                    <?php
                    if ($pesanGuru->gettingTotalChat($host, $_GET['to'], $pesanGuru->gettingAdmin($host)) == 0) {

                      echo "<h4>Belum Ada Pesan</h4>";
                    } else {

                      $ViewPesan_Arr = $pesanGuru->ViewChatting($host, $_GET['to'], $pesanGuru->gettingAdmin($host));
                      foreach ($ViewPesan_Arr as $view) :
                    ?>

                        <?php if ($view['pengirim'] == "admin") : ?>
                          <div class="container">
                            <a href="<?php echo "./php/pesanGuru.php?id=$view[id_pesan]&email=$_GET[to]" ?>" style="float: right; color:red;" data-tootlip="tooltip" title='Hapus'><i class="fas fa-trash"></i></a>
                    ...
                    <form action="./php/pesanGuru.php" method="post" class="mt-4">
                      ...
                      <input type="hidden" name="email_guru" value="<?php echo $_GET['to'] ?>">
                      <input type="hidden" name="username_admin" value="<?php echo $pesanGuru->gettingAdmin($host); ?>">
