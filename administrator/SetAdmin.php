    ...
    <div class="wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Setting Akun</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-12">
              ...
              <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                  ...
                  <?php
                  $DataAdmin_arr = $setAdmin->ViewProfil($host);

                  foreach ($DataAdmin_arr as $view) :
                  ?>
                    <form action="./php/setAdmin.php" method="post" enctype="multipart/form-data">

                      <div class="row">

                        <div class="col">
                          <label for="nama_app">Username</label>
                          <input type="text" name="username" id="username" class="form-control" required value="<?php echo $view['username'] ?>">
                        </div>

                        <div class="col">
                          <label for="password">Password <sup style="color:red;">Kosongkan Jika Tidak Perlu Diganti</sup></label>
                      ...
                      <div class="row mt-3">
                        <div class="col">
                          <label for="customfile">Nama Akun</label>
                          <input type="text" name="nama" id="nama" class="form-control" required value="<?php echo $view['nama'] ?>">
                        </div>
                        ...
                        <div class="col">
                          ...
                          <p class="mt-2">Profil Sekarang : <a href="<?php echo "dist/img/$view[gambar]" ?>"><?php echo $view['gambar'] ?></a></p>
                        </div>
                      </div>

                      <button class="btn btn-primary" type="submit" name="edit_admin">Update</button>
