    ...
    <div class="wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Pesan Students</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="Dashboard.php">Dashboard</a></li>
                <li class="breadcrumb-item active">Pesan Students</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                    ...
                    <tbody>
                      ...
                      ?>
                          <tr>
                            ...
                            <td>
                              <span class="badge badge-primary"><?php echo $pesansiswa->gettingTotalChat($host, $view['email'], $pesansiswa->gettingAdmin($host)) . " pesan" ?></span>
                            </td>
                            <td>
                              <a href="<?php echo "HubSiswa.php?to=$view[email]" ?>" class="badge badge-primary">Chat</a>
                            </td>
                          </tr>
                        <?php $i++;
                        endforeach ?>
