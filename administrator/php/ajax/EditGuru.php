        ...
        <div class="row">
            <div class="col-6 col-md-4 col-md-4">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        <?php
                        if ($EditGuru->OnlineChek($host, $view['email']) == 0) {
                        ?>
                        ...
                        <br>
                        <center>
                            <h5 class="mt-2">Kursus Yang Diampu</h5>
                        </center>
                        <p class="text-center card-text">
                            <?php
                            if ($EditGuru->TotalKelas($host, $view['email']) == 0) {
                            } else {

                                $Datakls_arr = $EditGuru->ViewKelas($host, $view['email']);
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <?php } else { ?>
                                <div class="col">
                                    <label for="lastname">Whatsapp Number</label>
                                    <input type="text" name="nohp" id="nohp" value="<?php echo $view['nohp_guru'] ?>" class="form-control">
                                </div>
                            <?php } ?>
                        </div>
