...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <ul class="navbar-nav navbar-center">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="#"><i class="fas fa-home"></i> Dashboard
              <span class="sr-only">(current)</span>
            </a>
          </li>

          <li class="nav-item active">
            <a class="nav-link" href="#"><i class="fas fa-clock"></i> Events
              <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#kelas"><i class="fas fa-school"></i> My Course</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container">
    ...
    <div class="input-group" style="margin-bottom: 20px;"> <input type="text" id="keyword" class="form-control" placeholder="Cari Pelatihan Kursus ...">
