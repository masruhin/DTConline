                    ...
                    <main>
                        <div class="container-fluid">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        ...
                                        <label class="custom-control-label" for="kontak_guru">Kontak Accessor</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                            ...
                            <div class="card mb-3" id="view_kontak_guruu">
                                <div class="card-body">
                                    <h5 class="card-text">Kontak Guru</h5>
                                    <hr>
                                    <?php
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <center>
                                                                <a href="javascript:void(0)" class="badge badge-success" data-toggle="popover" title="Kelas yang diampu" data-content='
                                                    <?php
                                                    ...
                                                    '>Please click</a>
                                                        ...
                                                        <td>
                                                            <center>
                                                                <span class="badge badge-info"><?php echo $pesan->JumlahPesan_siswaToGuru($host, $view_guru['email'], $q) . " pesan" ?></span>
                                                            </center>
                                                        </td>
                                                        <td>
                                                            <center>
