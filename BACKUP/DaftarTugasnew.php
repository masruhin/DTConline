                  ...
                  <table class="table dt-responsive nowrap" style="width:100%" style="width:100%" id="table_tugas">
                    ...
                    <tbody>
                      ...
                      ?>
                            <tr>
                              <td>
                                <center> <span class="badge badge-success badge-pill" style="font-weight: 500; padding: buttom 2px;">Belum Kumpul Tugas</span></center>
                              </td>
                              <td>
                        ...
                        if ($kumpultugas->JumlahSiswaBelumQuiz($host, $email, $view_tugas['id_quiz']) == 0) {
                          if ($view_tugas['id_quiz'] != NULL) { ?>
                            ...
                            <tr>
                              <td>
                                <center><span class="badge badge-info badge-pill" style="font-weight: 500; padding: buttom 2px;">Belum Quiz</span></center>
                              </td>
                              <td>
                                <center><?php echo $view_tugas['title'] ?></center>
                              </td>
