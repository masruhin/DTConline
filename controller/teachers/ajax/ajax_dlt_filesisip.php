...
<form action="../../controller/teachers/Class.php" method="post">
    <div class="form-group">
        <p class="card-text">Are you sure you want to delete the submission task place during on <?php echo $title ?></p>
    </div>
...
<hr>
    <button type="submit" value="edit_title" class="btn btn-danger" name="dlt_filesisip">Delete</button>
</form>